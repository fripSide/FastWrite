...
Note that all latex files should be named as "id-section-name.tex" (e.g., 1-intro.tex)
...
1. `bun src/cli.ts p myproject sections/` - Initialize project
...
4. Review changes in `sections/0-abstract.tex`

## Project Structure

```
sections/           # Your LaTeX files (0-abstract.tex, 1-intro.tex, ...)
projs/myproject/
